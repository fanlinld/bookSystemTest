	...
	<div id="mainPanle" region="center"
		...
		<div id="p" class="easyui-panel" title="书籍管理>图书管理"
			...
			<table id="dg">
				<thead>
					<tr>
						<th data-options="field:'name',width:80,sortable:true">书名</th>
						<th data-options="field:'author',width:80,sortable:true">作者</th>
						<th data-options="field:'press',width:90,sortable:true">出版社</th>
						<th data-options="field:'classify',width:35,sortable:true">类别</th>
						...
						<th data-options="field:'a2',width:20,align:'center',
							formatter: borrowformatCheck">借阅记录</th>
					</tr>
				</thead>
			</table>
				...
				<div class="easyui-panel" title="图书信息" style="width: 800px">
					<div style="padding: 10px 20px 10px 20px">
						<table cellpadding="3" cellspacing="3">
							...
							<tr>
								<td style="font-size: 14px;font-weight: bold;">是否读过</td>
								<td>
									<input type="radio" id="status0" name="status" value="0"  checked />未读
									<input type="radio" id="status1" name="status" value="1" />已读
									<input type="radio" id="status2" name="status" value="2" />在读
								 </td>
							</tr>
						</table>
			...
			<div style="padding: 5px 0px 5px 0px" id="toolbar">
				...
				<div style="float: right;">
					<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-save" plain="true"  
						style="margin-left:auto; margin-right:12px;" onclick="exportBooks()">导出书籍信息</a> 
				</div>
			</div>
				...
				<div id="queryView" class="easyui-window" title="高级查询" style="width: 30%" data-options="modal:true,closed:true,iconCls:'icon-search02'">
					<div style="padding: 10px 20px 10px 20px">
						<table cellpadding="3" cellspacing="3">
							...
							<tr>
								<td>译者:</td>
								<td><input id="selTranslator" name="seltranslator" class="easyui-textbox" prompt="" style="width: 300px;"></input></td>
							</tr>
							<tr>
								<td>丛书:</td>
...
<script type="text/javascript">
	...
	$('#ss').searchbox({
		searcher : function(value, name) {
			...
			if (name == 'bookName') {
				bookurl = '../../book/selectBooks?selbookName='
						+ encodeURIComponent(value)+"&source="+0;
				selbookName = value;
				selbookAuthor = "";
			}
			if (name == 'bookAuthor') {
				bookurl = '../../book/selectBooks?selbookAuthor='+value+"&source="+0;
				selbookAuthor = value;
				selbookName = "";
			}
	...
	function advanced(){
		...
		var selTranslator=$('#selTranslator').val();
	...
	function borrowformatCheck(value,row,index){
	...
	function exportBooks(){
		var exporturl="../../exportBookInfo";
		if(bookurl.indexOf("?")>0){
			var paramstr=bookurl.substring(bookurl.indexOf("?"));
			exporturl=exporturl+paramstr;
		}
